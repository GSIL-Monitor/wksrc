<template>
	<div class="app-container">
		...
		<el-table :key="tableKey" :data="list" v-loading="listLoding" element-loading-text="稍等片刻" border fit highlight-current-row style="width: 100%">
			...
			<el-table-column align="center" label="赠送金额(发票)" width="130">
				<template slot-scope="scope">
			...
			<el-table-column align="center" label="适用等级" width="100">
				<template slot-scope="scope">
					<span>{{scope.row.cLevel | displayNameFilter(levelOptions)}}</span>
					<!-- <span>{{scope.row.cLevel}}</span>  -->
				</template>
			</el-table-column>
			<el-table-column align="center" label="等级更变" width="100">
				<template slot-scope="scope">
					<span>{{scope.row.ncLevel | displayNameFilter(levelOptions)}}</span>
 ...
 style='margin-left:0px;'>
			 ...
			 <el-form-item label="适用等级" prop="cLevel">
