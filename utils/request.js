...
import { getSessionId, setSessionId } from '@/utils/store'
...
service.interceptors.request.use(config => {
  ...
  if (getSessionId()) {
    // config.headers['Cookie'] = getSessionId()
  }
...
service.interceptors.response.use(
  ...
  */
    ...
    res.code = res.code ? res.code : res.status_code
